...
print(
    "3: If you have created an app already, click the \"Details\" button. If not, then create one and follow the steps.")
print("4: Click the \"Keys and tokens\" link.")
print(
    "5: You will need both \"Consumer API keys\" (automatic) and \"Access token & access token secret\". Generate the 2nd set if needed.")
print(
    "6: Copy-paste or enter the following values from that page (input is CASE-SENSITIVE) and press Enter. Values will be saved locally for later use.")
